...
public class gp_quinperiodos {
	...
	public gp_quinperiodos(int xperiodo_id, int xanio_id,
			String xentorno_id, String xorganizacion_id, String xempresa_id,
			int xquincena_id, Date xfecha, String xdias, String xsigladias,
